...
export default function About() {
  ...
  // Fungsi JavaScript untuk membuka link WhatsApp di tab baru
  const handleWhatsAppClick = () => {
    // Memastikan link terbuka di tab/jendela baru
  ...
  return (
    <section id="layanan" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Konten (Tentang Layanan & Detail Layanan) */}
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          
          {/* Kolom Kiri: Tentang Layanan & Benefit */}
          ...
          {/* Kolom Kanan: Detail Layanan (Icon Cards) */}
          <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-cyan-500 to-blue-600 rounded-3xl p-8 lg:p-12 text-white text-center">
          ...
          {/* TOMBOL WHATSAPP DENGAN ONCLICK JAVASCRIPT */}
          <button
            onClick={handleWhatsAppClick} // <-- Panggil fungsi yang mengarahkan ke WA
